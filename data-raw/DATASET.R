...
### Original Data used to identify weights
...
toksBT17_20_clean <- corpus_to_compound_tokens(corpBT17_20, popdictR::gruendl_terms, include_totals = TRUE)
usethis::use_data(toksBT17_20, internal = FALSE,
                  overwrite = TRUE)
